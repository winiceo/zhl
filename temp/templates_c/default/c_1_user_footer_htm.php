...
plus/url_qrcode.php?url=<?php echo $this->_vars['QISHI']['site_dir'];  echo $this->_vars['QISHI']['android_download']; ?>
" width="80" height="80">
		        		</div>
		        		<div class="clear"></div>
		        	</div>
...
<br />
Powered by <a href="http://www.zhaohulu.com/" target="_blank" style="color:#009900"><em> 74cms v<?php echo $this->_vars['QISHI']['version']; ?>
 找葫芦网 版权所有</em></a><br />
</div>
</div>
<!-- 回到顶部组件 -->
...
'">我要建议</div>
	...
	<div class="sub">
		<div onclick="javascript:location.href='<?php echo $this->_run_modifier("QS_subscribe", 'qishi_url', 'plugin', 1); ?>
'">我要订阅</div>
	</div>
</div>
<script>
