...
function tpl_function_qishi_get_salary_data_salary_barchart($params, &$smarty)
{
	...
	if(!$result){
		$result = dfopen("http://www.zhaohulu.com/salary/get_salary_data_salary_barchart.php?district=".$aset['district']."&category=".$aset['category']."&certification=".$_SERVER['SERVER_NAME']);
