		...
		while($list = $db->fetch_array($result))
		{
			...
			if($type==1) 
			{
				...
				if($audit==2)
				{
					...
					$msg_p = "，奖励".$rule['report_jobs']['value']."葫芦币，感谢您对".$_CFG['site_name']."的支持！";
					...
					$msg_c = "，扣除".$rule['company_jobs_report_points']['value']."葫芦币，如再有此类情况发生将作封号处理！";
			...
			else 
			{
				...
				if ($audit==2)
				{
					...
					$msg = "，奖励".$rule['company_report_resume_points']['value']."葫芦币，感谢您对".$_CFG['site_name']."的支持！";
					...
					$msg_p = "，扣除".$rule['resume_report']['value']."葫芦币，如再有此类情况发生将作封号处理！";
