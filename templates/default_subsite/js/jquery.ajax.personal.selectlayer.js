...
function allaround() {
	...
	$(".ucc-default").click(function() {
		if (!$(this).hasClass('aui_is_show')) {
			...
			var left=($(".ui-dialog").width() - $(this).parent().find('.aui_outer').outerWidth())/2;
			var top =($(".ui-dialog").height() - $(this).parent().find('.aui_outer').outerHeight())/2 + $(document).scrollTop();
			$(this).parent().find('.aui_outer').css({	"position":"absolute","left":left,"top":top,"display":"block"});
